...
public class AllMyDrawings
{
	...
	StickFigure large = new StickFigure(100,50,225,150);
	StickFigure smallCC = new StickFigure(20,50,40,30);
	StickFigure tallSkinny = new StickFigure(20,150,20,40);
	StickFigure shortFat = new StickFigure(20,250,40,20);
	...
	FashionableStickFigure hattedSmallPerson = new FashionableStickFigure(20,50,40,30);
