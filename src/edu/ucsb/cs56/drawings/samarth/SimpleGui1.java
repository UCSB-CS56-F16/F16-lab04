package edu.ucsb.cs56.drawings.samarth;
...
public class SimpleGui1 {
    ...
    */
	...
	JButton button = new JButton("Click me OR ELSE YOU BETTER WATCH YOSELF") ;
	
	java.awt.Color myColor = new java.awt.Color(100,150,200);   // R, G, B values.
