...
public class MultiPictureComponent extends JComponent {
	 ...
	 * 
	 * There is a paintComponent method that is created for you in the JComponent class, but it doesn't do what we want,
	 * so we have to "override" that method with our own method.
	 */
