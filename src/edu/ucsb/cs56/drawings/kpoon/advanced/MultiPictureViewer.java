...
/**
 * A viewer class to see a picture I drew with just three simple Java graphics objects, namely Rectangle, Line2D.Double,
 * Ellipse2D.Double
 * 
 * @author P. Conrad
 * @author K.K. Poon
...
public class MultiPictureViewer {
	public static void main(String[] args) {
		...
		// Set your own title
		frame.setTitle("Kin's First Drawing"); // @@@ MODIFY THIS LINE
