 ...
 * 
 * This provides an example of how you can start with the coordinates of a hard coded object, and end up with an object
 * that can be drawn anywhere, with any width or height.
 * 
 * @author Phill Conrad
