package edu.ucsb.cs56.drawings.kpoon.simple;
...
/**
   A component that draws a Picture by Phill Conrad, fixed by K. Poon

   @author Phill Conrad (original drawing)
   @author Kin Kwan Poon (fixed the snowmans's head)
...
public class PictureComponent extends JComponent
{
	...
	// @@@ 20, 20 are suggested coordinates, but you may change them
		...
		g2.drawString("Snowman and a House, K.K. Poon", 20,20);
