package edu.ucsb.cs56.drawings.marioinfante;
...
public class SimpleGui1 {
    ...
    */
	...
	JButton button = new JButton("Click me my precious");
	
	java.awt.Color myColor = new java.awt.Color(204,250,153);   // R, G, B values.
