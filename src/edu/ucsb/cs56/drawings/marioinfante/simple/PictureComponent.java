package edu.ucsb.cs56.drawings.marioinfante.simple;
...
/**
   ...
   @author Mario Infante (fixed the snowmans's head)
...
{  
	...
	// @@@ 20, 20 are suggested coordinates, but you may change them
        ...
        g2.drawString("House and Snowman by Mario Infante", 20,20);
