package edu.ucsb.cs56.drawings.juan_pacheco.simple;
...
/**
   ...
   @author @@@ Juan Pacheco (fixed the snowmans's head)
...
{  
	...
	// @@@ 20, 20 are suggested coordinates, but you may change them
        ...
        g2.drawString("Fixed the snowman's head -Juan Pacheco", 20,20);
