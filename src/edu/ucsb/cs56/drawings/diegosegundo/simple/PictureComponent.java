package edu.ucsb.cs56.drawings.diegosegundo.simple;
...
/**
   ...
   @author Phill Conrad (original drawings
   @author @@@ D. Segundo (fixed the snowmans's head)
...
{  
	...
	// @@@ 20, 20 are suggested coordinates, but you may change them
         ...
         g2.drawString("Snowman by Diego Segundo", 20,20);
