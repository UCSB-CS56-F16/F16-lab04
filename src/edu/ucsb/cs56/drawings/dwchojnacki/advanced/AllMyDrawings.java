...
public class AllMyDrawings
{
	...
	g2.drawString("A bunch of Cubes by Daniel Chojnacki", 20,20);
	
	
	// Draw some coffee cups.
	
	Cube small = new Cube(200, 200, 30, 45);
	Cube medium = new Cube(400, 200, 60, 145);
	Cube large = new Cube(600, 200, 90, 200);
