package edu.ucsb.cs56.drawings.jimvargas.simple;
...
/**
   ...
   @author Jim Vargas (fixed the snowmans's head)
...
{  
	...
	// @@@ 20, 20 are suggested coordinates, but you may change them
        ...
        g2.drawString("Simple house and completed snowman by Jim Vargas", 20,20);
