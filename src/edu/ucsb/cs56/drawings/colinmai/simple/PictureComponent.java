package edu.ucsb.cs56.drawings.colinmai.simple;
...
/**
   ...
   @author Colin Mai (fixed the snowmans's head)
...
{  
	...
	// @@@ 20, 20 are suggested coordinates, but you may change them
         ...
         g2.drawString("Colin Mai and Frosty the Snowman(ask him about his carrot)", 20,20);
