...
public class IpodDetail extends Ipod implements Shape {
    ...
    */
    ...
    {	
        ...
        double scrollInnerY = y + screenHeight 
	    + (padding/2) + ((1.5 * bodyWidth)-screenHeight)/2;
        ...
        Ellipse2D.Double scrollWheelInner = 
	    new Ellipse2D.Double(scrollInnerX-scrollInnerRadius, 
				 scrollInnerY-scrollInnerRadius,
				 scrollInnerRadius*2, 
				 scrollInnerRadius*2);

        Rectangle2D.Double progress = 
	    new Rectangle2D.Double(progressX, progressY,
				   progressWidth, progressHeight);

        Rectangle2D.Double album 
	    = new Rectangle2D.Double(albumX, albumY,
