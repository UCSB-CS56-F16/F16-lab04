package edu.ucsb.cs56.drawings.cristobal_caballero.simple;
...
/**
   ...
   @author Cristobal Caballero (fixed the snowmans's head)
...
{  
	...
	// @@@ 20, 20 are suggested coordinates, but you may change them
        ...
        g2.drawString("Cristobal Caballero, drew top circle.", 20,20);
