...
*/
public class BoxedMilk extends BoxedDrink implements Shape
{
    /**
     * Constructor for objects of class BoxedMilk
     */
    public BoxedMilk(double x, double y, double width, double height)
    {
	...
	// Make one tab, spaced like this, where w=width/10.0;
	// | +--+ +--+ +--+ |
	// | |  | |  | |  | |
	// | +--+ +--+ +--+ |
	// |w 2w w 2w w w2 w|
	...
	double w = 0.10 * width;
	double winTop = y + 0.10 * height;
	double winHt =  0.15 * height;
	...
	// (Hint--is a method of "GeneralPath")
        ...
        GeneralPath wholeBoxedMilk = this.get();
        wholeBoxedMilk.append(win1, false);
