package edu.ucsb.cs56.drawings.jamesy2971.simple;
...
/**
   A component that draws a Picture by James Yang
   
   @author Phill Conrad (original drawing)
   @author @@@ James Yang (fixed the snowmans's head)
...
{  
	...
	// @@@ 20, 20 are suggested coordinates, but you may change them
         ...
         g2.drawString("Snowman by James Yang", 20,20);
