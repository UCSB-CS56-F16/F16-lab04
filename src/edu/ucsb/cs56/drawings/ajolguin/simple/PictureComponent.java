package edu.ucsb.cs56.drawings.ajolguin.simple;
...
/**
   ...
   @author @@@ Adrian Olguin (fixed the snowmans's head)
...
{  
	...
	// @@@ 20, 20 are suggested coordinates, but you may change them
        ...
        g2.drawString("Drew the head of the snowman, Adrian Olguin", 20,20);
