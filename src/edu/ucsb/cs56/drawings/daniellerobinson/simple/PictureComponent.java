package edu.ucsb.cs56.drawings.daniellerobinson.simple;
...
/**
   ...
   @author Danielle Robinson (fixed the snowmans's head)
...
{  
	...
	// @@@ 20, 20 are suggested coordinates, but you may change them
        ...
        g2.drawString("Danielle's Frosty the Snowman", 20,20);
