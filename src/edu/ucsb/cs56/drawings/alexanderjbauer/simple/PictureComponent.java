package edu.ucsb.cs56.drawings.alexanderjbauer.simple;
...
/**
   ...
   @author Alexander Bauer (fixed the snowmans's head)
...
public class PictureComponent extends JComponent
{
	...
	// @@@ 20, 20 are suggested coordinates, but you may change them
        ...
        g2.drawString("Grandpa's House, Alexander Bauer", 20,20);
