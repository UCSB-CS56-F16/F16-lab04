...
public class AllMyDrawings
{
	...
	g2.draw(ph1);
	g2.setColor(new Color(0x8F00FF)); g2.draw(ph2);
	
	// @@@ FINALLY, SIGN AND LABEL YOUR DRAWING
	
	g2.setStroke(orig);
	g2.setColor(Color.BLACK); 
	g2.drawString("A few Pots By Huiyang He", 20,20);
    }
	...
	Shape pp3 = ShapeTransforms.rotatedCopyOf(ph2, Math.PI/4.0);
	...
	g2.setStroke(orig);
	g2.setColor(Color.BLACK); 
	g2.drawString("A bunch of Coffee Cups and a few pots by Huiyang He", 20,20);
    }
