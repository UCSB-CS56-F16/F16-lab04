package edu.ucsb.cs56.drawings.sayalikakade.simple;
...
/**
   ...
   @author Sayali Kakade (fixed the snowmans's head)
...
{  
	...
	g2.draw(snowManTopCircle); 
        ...
        g2.drawString("A White Winter Wonderland, Sayali Kakade", 20,20);
