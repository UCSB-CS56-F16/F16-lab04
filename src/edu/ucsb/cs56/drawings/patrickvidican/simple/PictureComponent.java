package edu.ucsb.cs56.drawings.patrickvidican.simple;
...
/**
   ...
   @author Patrick Vidican (fixed the snowmans's head)
...
public class PictureComponent extends JComponent
{
	...
	Circle snowManTopCircle =
	    ...
	    (
	     snowManCenterBottomX,
	     snowManCenterBottomY - 2*bottomRadius - 2*middleRadius - topRadius,
	     topRadius
	    );
