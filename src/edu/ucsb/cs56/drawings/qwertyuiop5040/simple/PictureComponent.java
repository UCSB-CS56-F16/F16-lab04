package edu.ucsb.cs56.drawings.qwertyuiop5040.simple;
...
/**
   ...
   @author Hanqing Wang (fixed the snowmans's head)
...
{  
	...
	g2.drawString("Hanqing Wang: added snowman's head",20,20);
