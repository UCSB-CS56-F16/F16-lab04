package edu.ucsb.cs56.drawings.mkannan.simple;
...
/**
   ...
   @author Madhumathi Kannan (fixed the snowmans's head)
...
{  
	...
	// @@@ 20, 20 are suggested coordinates, but you may change them
         ...
         g2.drawString("Updated Snowman, by Madhumathi Kannan", 20,20);
