package edu.ucsb.cs56.drawings.adorotheo.simple;
...
/**
   ...
   @author Austin Dorotheo (fixed the snowmans's head)
...
{  
	...
	// @@@ 20, 20 are suggested coordinates, but you may change them
         ...
         g2.drawString("Snow Man's Head, by Austin Dorotheo", 20,20);
